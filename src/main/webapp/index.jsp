...
%>
				...
				<form action=signup method="post">
					...
					<input class="text" type="password" name="password" id="txtNewPassword" placeholder="Password" required="">
					<input class="text w3lpass" type="password" name="password" id="txtConfirmPassword" oninput="check(this)" placeholder="Confirm Password" required="">
					<font color="red">
...
<br>
				...
				<br>
				<p><a href="nonregister.jsp">Guest User</a></p>
