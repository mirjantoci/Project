...
<br>
<br>
<form  action="DownloadMultipleFiles3" onsubmit="return valids1()" name="form2">
...
%>
		...
		<tr align="center">
        	...
        	<input type="checkbox" value="stopPrivateRep" checked="checked" name="mine" style="opacity:0; position:absolute; left:9999px;">
...
<br/>
<br/>
<input class="center-block" type="submit" value="Download" name="s">
</form>
	</div>
