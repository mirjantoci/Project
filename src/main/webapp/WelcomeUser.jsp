...
if (nr_files != 0)
{
	 ...
	 out.print("<tr align=\"center\">");
	    ...
	    out.print("<input type=\"submit\" value=\"Delete\" name=\"s\" >");
	    out.print("&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"submit\" value=\"Edit\" name=\"s\">");
	    out.print("&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"submit\" value=\"Share\" name=\"s\">&nbsp;&nbsp;&nbsp;&nbsp");
	    out.print("&nbsp;&nbsp;&nbsp;&nbsp;<input type=\"submit\" value=\"Move\" name=\"s\">&nbsp;&nbsp;&nbsp;&nbsp");
